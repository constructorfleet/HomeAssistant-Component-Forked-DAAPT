...
from homeassistant.components.media_player.const import (
    MEDIA_TYPE_MUSIC, MEDIA_TYPE_PLAYLIST, SUPPORT_PLAY_MEDIA, SUPPORT_TURN_OFF, SUPPORT_TURN_ON,
    SUPPORT_VOLUME_MUTE,
    SUPPORT_VOLUME_SET)
...
class ForkedDaapd:
    ...
    def play_music(self, media_id, wholePath=True):
        ...
        os.system(
            "mpg123 --delay 3 --rate 44100 --stereo --stdout /config/tts/" + filename +
            " > /config/forked-daapd/music/HomeAssistantAnnounce")
        return {}
